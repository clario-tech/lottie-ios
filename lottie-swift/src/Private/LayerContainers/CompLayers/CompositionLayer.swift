 ...
 */
class CompositionLayer: SCNNode, Composition {
...
//  }
  ...
  final func displayWithFrame(frame: CGFloat, forceUpdates: Bool) {
    ...
    transform = transformNode.globalTransform
    opacity = CGFloat(transformNode.opacity)
    isHidden = !layerVisible
//    geometry.
